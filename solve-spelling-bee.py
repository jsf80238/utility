...
match_set = set()
for combination in itertools.combinations_with_replacement(letters, len(pattern)):
    for permutation in itertools.permutations(combination, len(pattern)):
        potential_match = "".join(list(combination))
        # print(potential_match)
        # Check whether this combination is a valid word
